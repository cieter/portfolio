...
const generateAsteroid = (x, y, radius, type) =>
{
...
const checkDistanceCollision = (obj1, obj2) =>
{
...
const generateAsteroidExplosion = (asteroid) =>
{
	let i = 18;
	for(i; i > -1; --i)
	{
...
const resolveAsteroidType = (asteroid) =>
{
...
const renderScanlines = () =>
{
	...
	for(i; i > -1; --i)
	{
		...
		context.strokeStyle = (Math.random() > 0.0001) ? '#FFFFFF' : '#222222';
		context.stroke();
	}
	context.globalAlpha = 1;
}
